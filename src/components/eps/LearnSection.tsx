...
const LearnSection = () => (
  <section className="relative overflow-hidden">
    <CellularBg />
    <div className="absolute inset-0 eps-bg-gradient-dark" style={{ opacity: 0.87 }} />
    <div className="relative z-10 eps-section-padding max-w-4xl mx-auto">
      <AnimatedSection className="text-center mb-16">
        <p className="eps-label-caps mb-4">Takeaways</p>
        <h2 className="eps-heading-section">What Decisions You Will Be Able to Make</h2>
      </AnimatedSection>
        ...
        {items.map((item, i) => (
          <AnimatedSection key={i} delay={i * 0.08}>
            <div className="flex items-start gap-5 group">
              <div className="mt-1.5 flex-shrink-0 w-8 h-px transition-all duration-500 group-hover:w-12" style={{ background: "hsl(168 100% 42% / 40%)" }} />
