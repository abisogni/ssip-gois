...
const GOISSection = () => (
  <section className="relative overflow-hidden">
    ...
    <div className="relative z-10 eps-section-padding max-w-4xl mx-auto text-center">
      <AnimatedSection>
        <p className="eps-label-caps mb-4">Connection</p>
        <h2 className="eps-heading-section mb-8">
          ...
          <a
            ...
            className="eps-text-gradient-primary hover:opacity-80 transition-opacity duration-300"
          >
