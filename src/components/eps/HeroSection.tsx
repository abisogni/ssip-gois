...
import inventiciaLogo from "@/assets/eps/inventicia-logo.png";
...
const HeroSection = () => (
  <section className="relative min-h-screen flex flex-col items-center justify-start overflow-hidden">
    ...
    <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full blur-[120px] z-[2]" style={{ background: "hsl(168 100% 42% / 5%)" }} />
    <div className="absolute bottom-1/3 right-1/4 w-80 h-80 rounded-full blur-[100px] z-[2]" style={{ background: "hsl(215 50% 55% / 5%)" }} />
    ...
    <div className="relative z-10 text-center max-w-[52rem] mx-auto px-8 mt-auto mb-auto flex flex-col items-center justify-center" style={{ paddingTop: "1vh", paddingBottom: "5vh" }}>
      ...
      >
        <span className="eps-text-gradient-primary">Inside a Microgravity Lab</span>
      </motion.h1>
    ...
    >
      <ChevronDown className="w-[18px] h-[18px]" style={{ color: "hsl(220 10% 50% / 0.4)", animation: "eps-scroll-hint 2s ease-in-out infinite" }} />
    </motion.div>
  </section>
);
